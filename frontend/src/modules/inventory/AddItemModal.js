...
const AddItemModal = ({ open, onClose, onItemAdded }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await inventoryService.addItem(submitData);
      onItemAdded(response.data); // Pass new item back to the parent
      ...
      setSubmitError('Failed to add item. Please check your input and try again.');
    } finally {
